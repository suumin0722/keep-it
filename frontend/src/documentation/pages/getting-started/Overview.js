...
import dashboard from "../../../images/documentation/documentation.png";
  ...
  <Row>
    ...
    <Col lg={9}>
      <Widget id="Overview">
        <h1>Overview</h1>
        <p className="lead">
          One React is an admin dashboard template built with React 16.5.2. Sing
          App goes beyond usual admin templates and provides you entire
          intuitive programming framework. Server Side Rendering and Node.js
          backend will even further speed up your development. You can use One
          React to build any type of web applications like SAAS, CMS, financial
          dashboards, project management tools, etc.
        </p>
        <p className="lead">
          Moreover, there is a version of{" "}
          <a
            rel="noreferrer noopener"
            href="https://flatlogic.com/admin-dashboards/sing-app-react-nodejs"
            target="_blank"
          >
            One React with Node.js
          </a>
      ...
      <Widget id="Support">
        <h2>Support forum</h2>
        <p className="lead">
          For any additional information please go to our support forum and
          raise your questions or feedback provide there. We highly appreciate
          your participation!
        </p>
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="btn btn-default text-gray fw-semi-bold"
        >
          Support forum
        </a>
      </Widget>
