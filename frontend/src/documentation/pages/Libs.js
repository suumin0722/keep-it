      ...
      <Row className={s.root}>
        ...
        <Col lg={9}>
          <Widget id="Animate.css">
            <h3>Animate.css</h3>
            <p>
              animate.css is a bunch of cool, fun, and cross-browser animations
            ...
            <SyntaxHighlighter language="javascript" style={tomorrow}>
              {'<h1 class="animated infinite fadeIn slow">Fade in</h1>'}
            </SyntaxHighlighter>
            <p>
          ...
          <Widget id="RC-Slider">
            ...
            <p>
              ...
              <a
                href="https://github.com/react-component/slider"
                target="_blank"
                rel="noopener noreferrer"
              >
                rc-slider
          ...
          <Widget id="Font-Awesome">
            ...
            <p className="lead">
              ...
              <Link to="/app/components/icons">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Formsy-React">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/forms/wizard">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Fullcalendar">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/extra/calendar">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Glyphicons-Halflings">
            ...
            <p>
              TIncludes over 250 glyphs in font format from the Glyphicon
              Halflings set
            </p>
            <h4>Examples</h4>
            <i className="bi bi-asterisk mr" />
            <i className="bi bi-heart mr" />
            <i className="bi bi-home mr" />
            <i className="bi bi-refresh mr" />
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/ui/icons">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Line-Awesome">
            <h3>Line-awesome</h3>
            <p>
              A single file that replaces Font Awesome with modern line icons.
            </p>
            <h4>Examples</h4>
          ...
          <Widget id="React-Sparkline">
            ...
            <p>
              This React.js plugin makes it easy to generate a number of
              different types of sparklines directly in the browser, using few
              lines of JSX.
            </p>
            <Sparklines
          ...
          <Widget id="React-Toastify">
            ...
            <p className="lead">
              Want to see examples?{" "}
              <Link to="/app/ui/notifications">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Rc-Hammerjs">
            <h3>Rc-hammerjs</h3>
            <p>
              ReactJS / HammerJS integration. Support touch events in your React
              app.
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/JedWatson/react-hammerjs"
                target="_blank"
                rel="noopener noreferrer"
              >
                HammerJS
          ...
          <Widget id="React-Autosize-Textarea">
            ...
            <p>
              A light replacement for built-in <code>&lt;textarea /></code>{" "}
              component which automatically adjusts its height to match the
              content.
            </p>
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/buildo/react-autosize-textarea"
                target="_blank"
                rel="noopener noreferrer"
              >
                Textarea
          ...
          <Widget id="React-dropzone">
            ...
            <p>
              Simple HTML5-compliant drag'n'drop zone for files built with
              React.js.
            </p>
            <p className="lead">
              Want to see examples? <Link to="/app/forms/elements">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="React-Google-Maps">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/maps/google">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="React-Maskedinput">
            ...
            <p>
              A React component for <code>&lt;input></code> masking, built on
              top of inputmask-core.
            </p>
            ...
            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/insin/react-maskedinput"
                target="_blank"
                rel="noopener noreferrer"
              >
                Masked Input
          ...
          <Widget id="React-MDE">
            <h3>React-mde</h3>
            <p>
              A simple yet powerful and extensible Markdown Editor editor for
              React. React-mde is built on top of Draft.js.
            </p>

            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/andrerpena/react-mde"
                target="_blank"
                rel="noopener noreferrer"
              >
                ReactMDE
          ...
          <Widget id="React-Shuffle">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/extra/gallery">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/FormidableLabs/react-shuffle"
                target="_blank"
                rel="noopener noreferrer"
              >
                Shuffle
          ...
          <Widget id="React-Slick">
            ...
            <p className="lead">
              Want to see examples?{" "}
              <Link to="/app/ecommerce/product">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="React-Sortable">
            ...
            <p>
              A components to turn any list into an animated, touch-friendly,
              sortable list.
            </p>
            <p className="lead">
              Want to see examples? <Link to="/app/ui/list-groups">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
          ...
          <Widget id="Rickshaw">
            ...
            <p className="lead">
              Want to see examples? <Link to="/app/charts/rickshaw">Click</Link>
            </p>
            <p>
              For more examples and documentation please refer to{" "}
              <a
                href="https://github.com/shutterstock/rickshaw"
                target="_blank"
                rel="noopener noreferrer"
              >
                Rickshaw
          ...
          <Widget id="Skycons">
            <h3>Skycons</h3>
            <p>
              Skycons is a set of ten animated weather glyphs, procedurally
              generated by JavaScript using the HTML5 canvas tag.
            </p>
            ...
            <ul className="check-list">
              <li className="lead">
                <a
                  ...
                  href="https://www.amcharts.com/docs/v4/getting-started/integrations/using-react/"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  {" "}
                ...
                . JavaScript Charts & Maps Programming library for all your data
                visualization needs.
              </li>
              <li className="lead">
                <a
                  className="fw-semi-bold"
                  href="https://github.com/ameyms/react-animated-number"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  {" "}
              ...
              <li className="lead">
                ...
                . With React Bootstrap you can build responsive, mobile-first
                projects on the web using React.js and the world's most popular
              ...
              <li className="lead">
                ...
                . Make your data come alive. Highcharts makes it easy for
                developers to set up interactive charts in their web pages.
              </li>
              <li className="lead">
                <a
                  className="fw-semi-bold"
              ...
              <li className="lead">
                ...
                . A Declarative Framework for Rapid Construction of Web-based
                Visualization
              </li>
              <li className="lead">
                <a
              ...
              <li className="lead">
                ...
                . This React package offers an easy and intuitive way of
                displaying Bootstrap-styled grids with data coming either from
                the client or from the server.
              </li>
              <li className="lead">
                <a
                  className="fw-semi-bold"
                  href="https://github.com/unsplash/react-trend"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  {" "}
