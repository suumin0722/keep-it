        ...
        <Col lg={9}>
          ...
          <Nav tabs className="bg-transparent mt">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultButtonTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultButtonTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.defaultButtonTabId}
          >
            <TabPane tabId="1">
              ...
              <Button color="gray" className="width-100 mb-xs mr-xs">
                Gray
              </Button>
              <Button color="inverse" className="width-100 mb-xs mr-xs">
                Inverse
              </Button>
            </TabPane>
            <TabPane tabId="2">
          ...
          <Nav tabs className="bg-transparent">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.outlineButtonsTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.outlineButtonsTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.outlineButtonsTabId}
          >
            <TabPane tabId="1">
              <Button outline color="default" className="width-100 mb-xs mr-xs">
                Default
              </Button>
              <Button outline color="primary" className="width-100 mb-xs mr-xs">
                Primary
              </Button>
              <Button outline color="info" className="width-100 mb-xs mr-xs">
                Info
              </Button>
              <Button outline color="success" className="width-100 mb-xs mr-xs">
                Success
              </Button>
              <Button outline color="warning" className="width-100 mb-xs mr-xs">
                Warning
              </Button>
              <Button outline color="danger" className="width-100 mb-xs mr-xs">
                Danger
              </Button>
              <Button outline color="gray" className="width-100 mb-xs mr-xs">
                Gray
              </Button>
              <Button outline color="inverse" className="width-100 mb-xs mr-xs">
                Inverse
              </Button>
            </TabPane>
            <TabPane tabId="2">
          ...
          <Nav tabs className="bg-transparent">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.buttonsSizeTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.buttonsSizeTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.buttonsSizeTabId}
          >
            <TabPane tabId="1">
              ...
              <p>
                <Button color="default" size="lg" className="mb-xs mr-xs">
                  Large button
                </Button>
                <Button color="primary" className="mb-xs mr-xs">
                  Default button
                </Button>
                <Button color="info" size="sm" className="mb-xs mr-xs">
                  Small button
                </Button>
                <Button color="success" size="xs" className="mb-xs mr-xs">
                  Tiny button
                </Button>
              </p>
            </TabPane>
