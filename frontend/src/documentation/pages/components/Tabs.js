        ...
        <Col lg={9}>
          ...
          <Nav tabs className="bg-transparent mt">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultTabsTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultTabsTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.defaultTabsTabId}
          >
            <TabPane tabId="1">First tab content</TabPane>
            <TabPane tabId="2">Second tab content</TabPane>
          </TabContent>
          <h4>Code</h4>
          <SyntaxHighlighter language="javascript" style={tomorrow}>
            {'<TabContent className="mb-xlg" activeTab={this.state.activeTabId}>\n' +
              '  <TabPane tabId="1">\n' +
              "    First tab content\n" +
              "  </TabPane>\n" +
              '  <TabPane tabId="2">\n' +
          ...
          <div className="card panel mt-lg mb-xs">
            ...
            >
              ...
              <div className="mb-0">
                ...
                <a className="accordion-toggle" role="button">
                  ...
                  <i
                    className={`fa fa-angle-down ${this.state.accordion[0] ? "expanded" : ""}`}
                  />
                </a>
              </div>
            </div>
            <Collapse className="panel-body" isOpen={this.state.accordion[0]}>
              <p>
                ...
                like accordions and navigation. Using the collapse plugin, we
                built a simple accordion by extending the panel component.
              </p>
            </Collapse>
          </div>
            ...
            >
              ...
              <div className="mb-0">
                ...
                <a className="accordion-toggle" role="button">
                  ...
                  <i
                    className={`fa fa-angle-down ${this.state.accordion[1] ? "expanded" : ""}`}
                  />
                </a>
              </div>
            </div>
          ...
          <div className="card panel mb-lg">
            ...
            >
              ...
              <div className="mb-0">
                ...
                <a className="accordion-toggle" role="button">
                  Random from the Web
                  <i
                    className={`fa fa-angle-down ${this.state.accordion[2] ? "expanded" : ""}`}
                  />
                </a>
              </div>
            </div>
            <Collapse className="panel-body" isOpen={this.state.accordion[2]}>
              <p>
                <span className="fw-semi-bold">Light Blue</span> - is a next
                generation admin template based on the latest Metro design.
                There are few reasons we want to tell you, why we have created
                it: We didn't like the darkness of most of admin templates, so
                we created this light one. We didn't like the high contrast of
                most of admin templates, so we created this unobtrusive one. We
                searched for a solution of how to make widgets look like real
                widgets, so we decided that deep background - is what makes
                widgets look real.
              </p>
