    ...
    return (
      <Row>
        ...
        <Col lg={9}>
          <h2>Popovers</h2>
          <p className="mb-lg">
            The Popover is similar to Tooltip; it is a pop-up box that appears
            when the user clicks on an element. The difference is that the
          ...
          <Nav tabs className="bg-transparent mt">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultPopoversTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultPopoversTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.defaultPopoversTabId}
          >
            <TabPane tabId="1">
              <Button
                className="mr"
            ...
            <TabPane tabId="2">
              <SyntaxHighlighter language="javascript" style={tomorrow}>
                {'<Button id="popover" type="button" color="info" onClick={this.toggle}>\n' +
                  "  Top\n" +
                  "</Button>\n\n" +
          ...
          <Nav tabs className="bg-transparent mt">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultTooltipsTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultTooltipsTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.defaultTooltipsTabId}
          >
            <TabPane tabId="1">
              <Button
                className="mr"
            ...
            <TabPane tabId="2">
              <SyntaxHighlighter language="javascript" style={tomorrow}>
                {'<Button className="mr" id="tooltip" type="button" color="info">\n' +
                  "  Left\n" +
                  "</Button>\n\n" +
