        ...
        <Col lg={9}>
          ...
          <Nav tabs className="bg-transparent mt">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultAlertsTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.defaultAlertsTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.defaultAlertsTabId}
          >
            <TabPane tabId="1">
              <p>
              ...
              {this.state.alertsOne.map((alert, index) => (
                <Alert
                  key={alert.id}
                  isOpen={alert.visible}
                  toggle={() => this.closeAlertOne(index)}
                  color={alert.type}
                >
          ...
          <Nav tabs className="bg-transparent">
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.transparentAlertsTabId === "1",
                })}
                onClick={() => {
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.state.transparentAlertsTabId === "2",
                })}
                onClick={() => {
          ...
          <TabContent
            className="mb-xlg"
            activeTab={this.state.transparentAlertsTabId}
          >
            <TabPane tabId="1">
              <p>
                Alerts are available for any length of text, as well as an
              ...
              {this.state.alertsTwo.map((alert, index) => (
                <Alert
                  className="alert-transparent"
                  key={alert.id}
                  isOpen={alert.visible}
                  toggle={() => this.closeAlertTwo(index)}
                  color={alert.type}
                >
                  <span dangerouslySetInnerHTML={{ __html: alert.msg }} />
                </Alert>
