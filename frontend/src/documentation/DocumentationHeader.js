        ...
        <div className="container">
          <div className="row w-100 d-flex align-items-center">
            <Nav>
              <NavItem>
                <NavLink
                  className="fs-lg d-lg-none d-md-none"
                  onClick={this.switchSidebar}
                >
                  <span className="rounded rounded-lg text-white d-md-none">
              ...
              <NavItem>
                <NavLink
                  className={classnames(s.logo, "d-sm-down-none px-4")}
                  href={"/documentation"}
                >
                  <span className={"fw-semi-bold"}>Flatlogic One React</span>{" "}
                  &nbsp; Documentation
                </NavLink>
              </NavItem>
            </Nav>
