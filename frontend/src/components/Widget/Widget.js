          ...
          {!customControls && mainControls && (
            <div className={`${s.widgetControls} widget-controls`}>
              ...
              {fullscreen && (
                ...
                >
                  <i
                    className={`bi bi-resize-${fullscreened ? "small" : "full"}`}
                  />
                  {showTooltip && (
                    <UncontrolledTooltip
                      placement={tooltipPlacement}
            ...
            <div className={`${s.widgetControls} widget-controls`}>
              {!fullscreened &&
                (customClose && !prompt ? (
                  ...
                  >
                    <i title="Close" className="bi bi-remove" />
                  </button>
                ) : (
                  <button
              ...
              {!fullscreened && customCollapse && (
                ...
                >
                  <i
                    title="Collapse"
                    className={`bi bi-chevron-${!collapseWidget ? "down" : "up"}`}
                  />
                </button>
              )}
              {customFullscreen && (
