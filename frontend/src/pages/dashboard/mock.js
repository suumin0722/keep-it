export default {
  ...
  notifications: [
    ...
    },
    {
      ...
      color: "info",
      content:
        '15 <span class="fw-semi-bold">Notifications</span> from Social Apps',
    },
  ],
  table: [
    {
  ...
  randomData: {
    first: [
      7, 7, 6, 2, 3, 4, 7, 4, 3, 1, 4, 4, 8, 3, 4, 10, 7, 10, 7, 2, 9, 2, 8, 9,
      7,
    ],
    second: [
      6, 6, 10, 10, 1, 9, 4, 1, 5, 1, 2, 3, 3, 5, 1, 9, 0, 7, 2, 4, 2, 2, 5, 9,
      7,
    ],
    third: [
      7, 9, 3, 7, 7, 4, 7, 2, 0, 1, 7, 4, 7, 2, 3, 5, 2, 3, 4, 9, 6, 10, 1, 7,
      1,
    ],
  },
};
