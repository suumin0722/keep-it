            ...
            <Widget
              title={
                <p style={{ fontWeight: 700 }}>
                  Draggable Grid &nbsp;
                  <span className="badge badge-danger fw-normal">
                    since 2.1
                  </span>
                </p>
              }
          ...
          <Col className="widget-container" xl={6} xs={12}>
            ...
            >
              <Widget
                ...
                widgetType="default"
                title={<p style={{ fontWeight: 700 }}>Default Widget</p>}
                customDropDown
              ...
              >
                <div className="list-group list-group-lg">
                  {this.state.gridData.shares.map((item) => (
                    <button
                      key={item.name}
                      className={`list-group-item text-left ${item.extraClass}`}
                    >
              ...
              <Widget
                prompt={true}
                id="autoload-widget"
                title={<p style={{ fontWeight: 700 }}>Autoload Widget</p>}
                customDropDown={true}
              >
                <div>
                  ...
                  <p className="lead text-muted text-center">
                    Faith makes it possible to achieve that which man&apos;s
                  ...
                  <Form>
                    ...
                    <p>
                      To make a widget automatically load it's content you just
                      need to set <strong>autoload</strong> attribute and
                      provide an api to update the widget content.
                    </p>
                    <pre>
                      <code>
                    ...
                    <p>
                      <strong>autoload</strong> may be set to an integer value.
                      If set, for example, to 2000 will refresh widget every 2
                      seconds.
                    </p>
              ...
              <Widget>
                <header>
                  <p style={{ fontWeight: 700 }}>Custom Loader</p>
                </header>
                    ...
                    <li className={item.extraClass} key={item.title}>
                      ...
                      <div className="news-item-info">
                        <h5 className="name m-0 mb-xs">
                          <a href="#/app/grid">{item.title}</a>
                        </h5>
                        <p className="fs-mini">{item.description}</p>
