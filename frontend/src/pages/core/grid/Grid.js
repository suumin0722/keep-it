...
const Typography = () => (
  <div>
    <Row>
      <Col xs={12} md={6}>
        <Widget
          title={<p style={{ fontWeight: 700 }}>How it works</p>}
          customDropDown
        >
          <p>
          ...
          <div className="bg-light p-3">
            <Row className="mb-lg">
              <Col xs={4}>
                <div
                  className="py-4 text-center text-white p-1"
                  style={{ background: "#FEB04A" }}
                >
      ...
      <Col xs={12} md={6}>
        <Widget
          title={<p style={{ fontWeight: 700 }}>Equal width</p>}
          customDropDown
        >
          <p>
    ...
    <Row>
      <Col>
        <Widget
          title={<p style={{ fontWeight: 700 }}>Grid options</p>}
          customDropDown
        >
          <p>
    ...
    <Row>
      <Col xs={12} md={6}>
        <Widget
          title={<p style={{ fontWeight: 700 }}>Vertical Alignment</p>}
          customDropDown
        >
          <p>
