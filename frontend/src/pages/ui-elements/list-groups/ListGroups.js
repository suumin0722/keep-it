  ...
  if (value.children) {
    return (
      <li className="dd-item">
        <div className="dd-handle" data-id={value.id}>
          {" "}
          {value.text}{" "}
        </div>
...
class ListGroups extends React.Component {
  ...
  render() {
    return (
      <div>
        <Widget
          title={<p style={{ fontWeight: 700 }}>Grouped Lists</p>}
          customDropDown
        >
          <h6>
            Closest <span className="fw-semi-bold">Stars</span>
          </h6>
          <p>
            Try to play around with this list. Are you ready to pass an exam on
            astronomy?
          </p>
        ...
        <Widget
          title={
            <h3>
              Nestable <span className="fw-semi-bold">List</span>
            </h3>
          }
          close
          refresh
          ...
          <Row className="nestable">
            <Col md="6" xs="12" className="mb-xs">
              <SortableTree
                ...
                onChange={(nestableFirstItems) =>
                  this.setState({ nestableFirstItems })
                }
              />
            </Col>
            <Col md="6">
              <SortableTree
                ...
                onChange={(nestableSecondItems) =>
                  this.setState({ nestableSecondItems })
                }
              />
            </Col>
          </Row>
