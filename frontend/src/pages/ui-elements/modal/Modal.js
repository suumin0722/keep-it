      ...
      <div>
        <Row>
          <Col xs={12} md={6}>
            <Widget
              className="mb-xlg"
              title={<p style={{ fontWeight: 700 }}>Live Demo</p>}
              customDropDown
            >
              <p>
              ...
              <Button
                color="warning"
                onClick={() => this.toggle("scrollingLong")}
              >
                Scrolling long content
              </Button>
            </Widget>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Optional Sizes</p>}
              customDropDown
            >
              <p>
                Modals have two optional sizes, available via modifier .modal-sm
                and .modal-lg classes to be placed on a .modal-dialog. These
              ...
              <Button color="warning" onClick={() => this.toggle("small")}>
                Small modal
              </Button>
            </Widget>
          </Col>
          <Col xs={12} md={6}>
            <Widget
              className="mb-xlg"
              title={<p style={{ fontWeight: 700 }}>Using Grid</p>}
              customDropDown
            >
              <p>
                Utilize the Bootstrap grid system within a modal by nesting{" "}
                <code>&lt;Container fluid&gt;</code> within the{" "}
                <code>&lt;ModalBody&gt;</code>. Then, use the normal grid system
                classes as you would anywhere else.
              </p>
              <div className="bg-light p-3">
                <Button color="warning" onClick={() => this.toggle("launch")}>
                  Launch
                </Button>
        ...
        <Modal isOpen={demo} toggle={() => this.toggle("demo")}>
          ...
          <ModalBody className="bg-white">...</ModalBody>
          <ModalFooter>
            <Button
              color="default"
            ...
            <Button color="warning" className={"text-capitalize"}>
              Save changes
            </Button>
          </ModalFooter>
        </Modal>
        ...
        <Modal
          isOpen={scrollingLong}
          toggle={() => this.toggle("scrollingLong")}
        >
          <ModalHeader toggle={() => this.toggle("scrollingLong")}>
            Long content
          </ModalHeader>
        ...
        <Modal size="lg" isOpen={large} toggle={() => this.toggle("large")}>
          ...
          <ModalBody className="bg-white">
            ...
            harum? Quidem, quisquam, natus repellat debitis veniam quia facilis
            magni tempora cupiditate odio vitae? Eligendi nisi consequuntur vero
            tenetur nemo!
          </ModalBody>
          <ModalFooter>
            <Button
        ...
        <Modal size="sm" isOpen={small} toggle={() => this.toggle("small")}>
          <ModalHeader toggle={() => this.toggle("small")}>
            Small modal
          </ModalHeader>
          <ModalBody className="bg-white">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. In, illum
          ...
          <ModalFooter>
            <Button color="default" onClick={() => this.toggle("small")}>
              Close
            </Button>
        ...
        <Modal isOpen={launch} toggle={() => this.toggle("launch")}>
          <ModalHeader toggle={() => this.toggle("launch")}>
            Small modal
          </ModalHeader>
          <ModalBody className="bg-white text-white">
            <Container fluid>
              <Row>
                <Col md={4}>
                  <div className="h-100 w-100 bg-warning p-2">.col-md-4</div>
                </Col>
                <Col md={4} className="ml-auto">
                  <div className="h-100 w-100 bg-warning p-2">
                    .col-md-4 .ml-auto
                  </div>
                </Col>
              </Row>
