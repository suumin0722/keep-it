          ...
          <Col xs={6}>
            ...
            >
              ...
              {alerts.map((alert, index) => (
                <Alert
                  key={alert.id}
                  isOpen={alert.visible[0]}
                  toggle={() => this.closeAlert(index, 0)}
                  color={alert.type}
                >
          ...
          <Col xs={6}>
            ...
            >
              <p>
                ...
                <code>.alert-transparent</code> class.
              </p>
              {alerts.map((alert, index) => (
                <Alert
          ...
          <Col xs={6}>
            ...
            >
              <p>
                ...
                <code>.alert-rounded</code> class.
              </p>
              {alerts.map((alert, index) => (
                <Alert
                  className={cx("alert-rounded", {
                    "alert-transparent": index % 2 !== 1,
                  })}
                  key={alert.id}
                  isOpen={alert.visible[2]}
                  toggle={() => this.closeAlert(index, 2)}
                  color={alert.type}
                >
                  <span dangerouslySetInnerHTML={{ __html: alert.msg }} />
                </Alert>
