...
const Cards = () => (
  <div>
    <p>
      ...
      colors, and powerful display options. If you’re familiar with Bootstrap 3,
      cards replace its old panels, wells, and thumbnails. Similar functionality
      ...
      <Col>
        ...
        >
          <CardBody className="text-white">
            ...
            <Button className="btn-rounded-f mt-lg" color="danger">
              Full Article
            </Button>
          </CardBody>
        </Card>
        ...
        <Card className="border-0 mb-xlg">
          ...
          <CardBody>
            ...
            <CardText>
              ...
              three-dimensional in two dimensions in technical and engineering
              drawings.
            </CardText>
            <div className="w-100 text-center">
              <Button className="btn-rounded-f" color="primary">
                Full Article
              </Button>
            </div>
          </CardBody>
      ...
      <Col xs={12} sm={6} md={4}>
        <Card className="mb-xlg border-0">
          <CardBody>
            ...
            <button className="btn-link fw-semi-bold text-muted ml-sm">
              All Time
            </button>
            <hr />
        ...
        <Card className="mb-xlg border-0" style={{ position: "relative" }}>
          ...
          <Badge
            className="mt-lg fw-thin rounded-0"
            color="success"
          ...
          <CardBody>
            ...
            <hr />
            <CardText>
              There are at least 109 mountains on Earts with elevations greeter
              than 7,200 meters
            </CardText>
            <Button className="border-0" color="default">
              Read More
            </Button>
          </CardBody>
        </Card>
      ...
      <Col xs={12} sm={6} md={4}>
        <Card className="border-0 mb-4">
          ...
          <CardBody>
            ...
            <br />
            <CardTitle className="mb mt-xs">React Native Starter</CardTitle>
            <hr />
