            ...
            <TabContent className='mb-lg shadow' activeTab={this.state.activeFirstTab}>
              <TabPane tabId="tab11">
                ...
                <div className="float-right">
                  ...
                  <Button color="default">Some button</Button>
                </div>
                <div className="clearfix"/>
              </TabPane>
              ...
              <TabPane tabId="tab12">
                ...
                <div className="clearfix">
                  <div className="btn-toolbar">
                    <a className="btn btn-default ml-0">&nbsp;&nbsp;Check&nbsp;&nbsp;</a>
              ...
              <Col xs="12" className="mb-5">
                ...
                <TabContent className='mb-lg shadow' activeTab={this.state.activeSecondTab}>
                  ...
                  <TabPane tabId="tab22">
                    ...
                    <div className="clearfix">
                      <div className="btn-toolbar">
                        <Button color="danger" className={"ml-0"}>&nbsp;&nbsp;Check&nbsp;&nbsp;</Button>
                ...
                >
                  ...
                  <div className="mb-0">
                    ...
                    <a className="accordion-toggle" role="button">
                      {element.title}
                      <i
                        className={`fa fa-angle-down ${this.state.accordionFirst[index] ? "expanded" : ""}`}
                      />
                    </a>
                  </div>
                </div>
