    ...
    return (
      <div>
        <h2 className="page-title">
          Product - <span className="fw-semi-bold">Detail</span>
        </h2>
        <Widget title={(isNew ? "New" : "Edit") + " product"} collapse close>
          {!isNew && this.props.isReceiving ? (
            <Loader size={40} />
          ) : (
            <Form>
              <FormGroup row>
                <Label md={2} for="productImage">
                  Image
                </Label>
                <Col md={5}>
                  <Dropdown
                  ...
                  >
                    ...
                    <DropdownMenu>
                      {this.props.images.map((img) => (
                        <DropdownItem
                          key={img}
                          onClick={() => this.updateProduct(img, "img")}
                        >
              ...
              <FormGroup row>
                <Label md={2} for="productSubtitle">
                  Subtitle
                </Label>
                <Col md={5}>
                  <Input
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "subtitle")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productPrice">
                  Price
                </Label>
                <Col md={2}>
                  <Input
              ...
              <FormGroup row>
                <Label md={2} for="productDiscount">
                  Discount
                </Label>
                <Col md={2}>
                  <Input
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "discount")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productDescription_1">
                  Description 1
                </Label>
                <Col md={5}>
                  <textarea
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "description_1")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productDescription_2">
                  Description 2
                </Label>
                <Col md={5}>
                  <textarea
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "description_2")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productCode">
                  Code
                </Label>
                <Col md={2}>
                  <Input
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "code")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productHashtag">
                  Hashtag
                </Label>
                <Col md={5}>
                  <Input
                    ...
                    onChange={(event) =>
                      this.updateProduct(event.target.value, "hashtag")
                    }
                  />
                </Col>
              </FormGroup>
              <FormGroup row>
                <Label md={2} for="productTechnology">
                  Technology
                </Label>
                <Col md={5}>
                  <TagsInput
                      ...
                      <PopoverBody className="px-5 d-flex justify-content-center">
                        <ButtonToolbar>
                          <Button
                            color="success"
                            size="xs"
                            onClick={this.deleteProductRequest}
                          >
                            Yes
                          </Button>
                          <Button
