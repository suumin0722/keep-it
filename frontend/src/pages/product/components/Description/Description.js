    ...
    return (
      <div>
        <div className={s.productDescription}>
          <div
            className={cx(s.productDescriptionInfo, s.productDescriptionBlock)}
          >
        ...
        <Row className={cx(s.productDescription, s.productDescriptionMobile)}>
          <Col xs="12">
            <div className="card panel">
              <div
                className="card-header panel-header panel-first"
                role="button"
                onClick={() => {
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    PRODUCT DESCRIPTION
                    <i
                      className={`fa fa-angle-down fa-2x ${this.state.accordion[0] ? "expanded" : ""}`}
                    />
                  </button>
                </div>
              </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    PRODUCT CODE
                    <i
                      className={`fa fa-angle-down fa-2x ${this.state.accordion[1] ? "expanded" : ""}`}
                    />
                  </button>
                </div>
              </div>
              <Collapse className="panel-body" isOpen={this.state.accordion[1]}>
                <div className="card-body">{data.code}</div>
              </Collapse>
            </div>
            <div className="card panel">
              <div
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    SHARE
                    <i
                      className={`fa fa-angle-down fa-2x ${this.state.accordion[2] ? "expanded" : ""}`}
                    />
                  </button>
                </div>
              </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    TECHNOLOGY
                    <i
                      className={`fa fa-angle-down fa-2x ${this.state.accordion[3] ? "expanded" : ""}`}
                    />
                  </button>
                </div>
              </div>
              ...
              >
                <div className="mb-0">
                  <button className="accordion-toggle">
                    RATING & REVIEWS
                    <i
                      className={`fa fa-angle-down fa-2x ${this.state.accordion[4] ? "expanded" : ""}`}
                    />
                  </button>
                </div>
              </div>
