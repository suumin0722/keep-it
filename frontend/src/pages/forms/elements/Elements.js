    ...
    return (
      <div className={s.root}>
        <Row>
          ...
          <Col lg={6} md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Inputs</p>}
              customDropDown
            >
              <FormGroup>
                <Form>
        ...
        <Row>
          <Col lg={8} md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Form Options</p>}
              customDropDown
            >
              <Form>
        ...
        <Row>
          <Col lg="6" md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Textareas</p>}
              customDropDown
            >
              <Form>
        ...
        <Row>
          <Col md="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Checkbox Controls</p>}
              customDropDown
            >
              <Row>
                <Col lg="4">
        ...
        <Row>
          <Col md="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Radio Controls</p>}
              customDropDown
            >
              <Form>
                <Row>
        ...
        <Row>
          <Col lg="6" md="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Pickers</p>}
              customDropDown
            >
              <Form>
          ...
          <Col lg="6" md="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Input Masks</p>}
              customDropDown
            >
              <Form className="form-label-left">
        ...
        <Row>
          <Col xs="12">
            <Widget
              title={<p style={{ fontWeight: 700 }}>Sliders</p>}
              customDropDown
            >
              <Row>
                <Col lg="4">
                  <h4>Color Options</h4>
                  <p>
                    Sing extends <strong>rc-slider</strong> and provides
                ...
                <Col lg="4">
                  ...
                  <p>
                    Range selector can be displayed via{" "}
                    <strong>{"<RangeTooltip />"} </strong>tag. Price range
                    selector:
                  </p>
                  <Row>
                    <Col md={10}>
        ...
        <Row>
          <Col lg="6" md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Simple file uploads</p>}
              customDropDown
            >
              <Form>
          ...
          <Col lg="6" md={12}>
            <Widget
              title={<p style={{ fontWeight: 700 }}>Drop Zone</p>}
              customDropDown
            >
              <div>
                <Dropzone
